            ...
            <div className="flex flex-col sm:flex-row justify-between items-center gap-6 sm:gap-12">
              ...
              <div className="flex items-center gap-4 w-full sm:w-auto">
                ...
                <div>
                  ...
                  <p className="text-lg sm:text-xl lg:text-2xl text-gray-600"> {startDate.split("T")[0]}</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 w-full sm:w-auto">
                ...
                <div>
                  ...
                  <p className="text-lg sm:text-xl lg:text-2xl text-gray-600">{endDate.split("T")[0]}</p>
                </div>
              </div>
